...
from QuickPotato.statistical.visualizations import FlameGraph, HeatMap, CsvFile, BarGraph
...
BarGraph(test_case_name=pt.test_case_name, test_ids=[pt.current_test_id, pt.previous_test_id]).export("C:\\temp\\")
